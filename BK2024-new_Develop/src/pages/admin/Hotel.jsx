                    ...
                    <div className="container-fluid py-1 px-3">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                ...
                                <li className="breadcrumb-item text-sm text-white active text-uppercase" aria-current="page">danh sách Khách sạn</li>
                            </ol>
                            <h6 className="font-weight-bolder text-white mb-0 text-uppercase">Khách sạn</h6>
                        </nav>
                                        ...
                                        <table className="table align-items-center mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Số phòng</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p className="text-xs font-weight-bold mb-0">số lượng</p>
                                                        <p className="text-xs text-secondary mb-0">2 phòng</p>
                                                    </td>
                                                    ...
                                                    <td className="align-middle text-center text-sm">
                                                        <span className="badge badge-sm bg-gradient-success">Mở cửa</span>
                                                    </td>
